...
<svelte:head>
	<title>{pageTitle('Tính giá lăn bánh')}</title>
	<meta
		name="description"
		content="Tính giá lăn bánh xe điện tại Việt Nam. Bao gồm phí trước bạ, biển số, bảo hiểm và các chi phí khác theo từng tỉnh thành."
	/>
</svelte:head>
...
<div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
	...
	<div class="text-center">
		<h1 class="text-3xl font-bold text-gray-900">Tính Giá Lăn Bánh</h1>
		<p class="mt-2 text-gray-500">
			Tính toán chi phí thực tế khi mua xe điện tại Việt Nam, bao gồm tất cả phí và lệ phí.
		</p>
	</div>
		...
		<div class="space-y-6">
			...
			{#if !selectedCar}
				<div class="rounded-lg bg-gray-50 p-4">
					<p class="text-sm font-medium text-gray-700">Xe phổ biến</p>
		...
		<div>
			{#if breakdown}
				<div class="rounded-xl border border-gray-200 bg-white p-6">
					<h2 class="mb-4 text-lg font-semibold text-gray-900">Chi tiết giá lăn bánh</h2>
			...
			{:else}
				<div class="flex h-full items-center justify-center rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 p-8">
					<div class="text-center">
						...
						<p class="mt-2 font-medium text-gray-500">Chọn xe để tính giá lăn bánh</p>
						<p class="mt-1 text-sm text-gray-400">Kết quả sẽ hiển thị ở đây</p>
					</div>
				</div>
			{/if}
		</div>
	...
	<div class="mt-12 rounded-xl bg-blue-50 p-6">
		<h3 class="font-semibold text-blue-900">Lưu ý về chính sách ưu đãi xe điện</h3>
		<ul class="mt-3 space-y-2 text-sm text-blue-800">
			<li class="flex items-start gap-2">
				...
				<span>Xe điện được <strong>miễn 100% phí trước bạ</strong> đến hết tháng 2/2027 theo Nghị định 10/2022/NĐ-CP.</span>
			</li>
			<li class="flex items-start gap-2">
				<svg class="mt-0.5 h-4 w-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
					<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
				</svg>
				<span>Phí biển số: Hà Nội và TP.HCM là 20 triệu, các tỉnh thành khác từ 1-4 triệu VND.</span>
			</li>
			<li class="flex items-start gap-2">
				<svg class="mt-0.5 h-4 w-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
					<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
				</svg>
				<span>Giá tính toán là giá tham khảo, có thể thay đổi theo chính sách của từng đại lý.</span>
			</li>
		</ul>
	</div>
</div>
